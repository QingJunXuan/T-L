<template>
  <div>
    ...
    <el-dialog :visible.sync="loginTableVisible" width="500px" :center="true" @close="clearForm">
    ...
    <el-dialog :visible.sync="registerTableVisible" width="900px" :center="true" @close="clearForm">
      <div style="padding: 10px 70px 10px 70px">
        <h2>REGISTER</h2>
        <el-form
          :model="ruleForm1"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules1: {
        email: [{ required: true, validator: emailValidity, trigger: "blur" }],
        name: [{ required: true, message: "请输入姓名", trigger: "blur" }],
        number: [{ required: true, message: "请输入学号", trigger: "blur" }],
        gender: [{ required: true, message: "请选择性别", trigger: "blur" }],
        auth: [{ required: true, message: "请选择身份", trigger: "blur" }],
        password: [
    ...
    handleRegister(ev) {
      this.$refs.ruleForm1.validate(valid => {
        ...
        if (valid) {
          ...
          that.$http
            .post("http://10.60.38.173:8765/register", {
