  ...
  <el-container>
    <el-main>
      <div class="main">
        ...
        <el-card>
          <div slot="header">
            <span><el-button circle style="border-color: #fff" @click="index--" :class="index === 0? 'buttonHid' : ''"><i class="el-icon-arrow-left"></i></el-button></span>
          ...
          <div v-for="i in question.length" :key="i" align="start" class="question">
            ...
            <div style="margin-top: 15px">
              ...
              <el-select v-model="studentInfo[index].score[i - 1]" size="small" style="width: 100px">
              <el-option
